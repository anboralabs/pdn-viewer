...
import co.anbora.labs.pdn.options.EditorOptions;
...
final class EditorOptionsImpl implements EditorOptions, JDOMExternalizable {
  ...
  EditorOptionsImpl(PropertyChangeSupport propertyChangeSupport) {
    ...
    transparencyChessboardOptions =
        new TransparencyChessboardOptionsImpl(propertyChangeSupport);
  ...
  public void inject(EditorOptions options) {
    ...
    transparencyChessboardOptions.inject(
        options.getTransparencyChessboardOptions());
  ...
  public void readExternal(Element element) throws InvalidDataException {
    ...
    fileNameVisible = fileNameVisibleAttr == null ||
                      Boolean.parseBoolean(fileNameVisibleAttr);
    String fileSizeVisibleAttr = element.getAttributeValue("fileSizeVisible");
    fileSizeVisible = fileNameVisibleAttr == null ||
                      Boolean.parseBoolean(fileSizeVisibleAttr);
  }
