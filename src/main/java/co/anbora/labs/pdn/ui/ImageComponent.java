// Copyright 2000-2019 JetBrains s.r.o. Use of this source code is governed by
...
import co.anbora.labs.pdn.options.GridOptions;
import co.anbora.labs.pdn.options.TransparencyChessboardOptions;
import co.anbora.labs.pdn.options.impl.ImageEditorColorSchemeSettingsKt;
...
public class ImageComponent extends JComponent {
  ...
  @NonNls
  public static final String TRANSPARENCY_CHESSBOARD_CELL_SIZE_PROP =
      "TransparencyChessboard.cellSize";
  @NonNls
  public static final String TRANSPARENCY_CHESSBOARD_WHITE_COLOR_PROP =
      "TransparencyChessboard.whiteColor";
  @NonNls
  public static final String TRANSPARENCY_CHESSBOARD_BLACK_COLOR_PROP =
      "TransparencyChessboard.blackColor";
  @NonNls
  private static final String TRANSPARENCY_CHESSBOARD_VISIBLE_PROP =
      "TransparencyChessboard.visible";
  @NonNls
  private static final String GRID_LINE_ZOOM_FACTOR_PROP =
      "Grid.lineZoomFactor";
  ...
  public ImageComponent() { updateUI(); }

  public ImageDocument getDocument() { return document; }
  ...
  public void setTransparencyChessboardCellSize(int cellSize) {
    ...
    if (oldValue != cellSize) {
      ...
      firePropertyChange(TRANSPARENCY_CHESSBOARD_CELL_SIZE_PROP, oldValue,
                         cellSize);
    }
  }
  ...
  public void setTransparencyChessboardWhiteColor(Color color) {
    ...
    if (oldValue != null && !oldValue.equals(color) ||
        oldValue == null && color != null) {
      chessboard.setWhiteColor(color);
      firePropertyChange(TRANSPARENCY_CHESSBOARD_WHITE_COLOR_PROP, oldValue,
                         color);
    }
  }
  ...
  public void setTransparencyChessboardBlankColor(Color color) {
    ...
    if (oldValue != null && !oldValue.equals(color) ||
      ...
      firePropertyChange(TRANSPARENCY_CHESSBOARD_BLACK_COLOR_PROP, oldValue,
                         color);
    }
  }
  ...
  public void setTransparencyChessboardVisible(boolean visible) {
    ...
    if (oldValue != visible) {
      ...
      firePropertyChange(TRANSPARENCY_CHESSBOARD_VISIBLE_PROP, oldValue,
                         visible);
    }
  }
  ...
  public boolean isFileNameVisible() { return myFileNameVisible; }
  ...
  public boolean isBorderVisible() { return myBorderVisible; }
  ...
  public int getGridLineZoomFactor() { return grid.getLineZoomFactor(); }

  public int getGridLineSpan() { return grid.getLineSpan(); }

  public Color getGridLineColor() { return grid.getLineColor(); }
  ...
  public String getDescription() {
    ...
    if (image != null) {
      return ImagesBundle.message("icon.dimensions", image.getWidth(),
                                  image.getHeight(),
  ...
  public Dimension getCanvasSize() {
    ...
    return new Dimension(size.width - IMAGE_INSETS * 2,
                         size.height - IMAGE_INSETS * 2);
  }
  ...
  private static class ImageDocumentImpl implements ImageDocument {
    ...
    private final CompatibilityScaleContextCache<Rectangle> cachedBounds =
        new CompatibilityScaleContextCache<>((ctx) -> {
      ...
      myComponent.addPropertyChangeListener(new PropertyChangeListener() {
        ...
        public void propertyChange(PropertyChangeEvent e) {
          if (e.getPropertyName().equals("ancestor") &&
              e.getNewValue() == null && imageProvider != null) {
    ...
    public BufferedImage getValue(double scale) {
      return imageProvider != null ? imageProvider.apply(scale, myComponent)
                                   : null;
    }
    ...
    public void setValue(ScaledImageProvider imageProvider) {
      this.imageProvider = imageProvider instanceof CachedScaledImageProvider
                               ...
                               : imageProvider != null
                               ? (zoom, ancestor)
          -> imageProvider.apply(zoom, ancestor)
          : null;
  ...
  private static final class Chessboard {
    ...
    private Color whiteColor =
        TransparencyChessboardOptions.DEFAULT_WHITE_COLOR;
    private Color blackColor =
        TransparencyChessboardOptions.DEFAULT_BLACK_COLOR;
  ...
  private static final class Grid {
    ...
    public int getLineZoomFactor() { return lineZoomFactor; }

    public void setLineZoomFactor(int lineZoomFactor) {
      this.lineZoomFactor = lineZoomFactor;
    }

    public int getLineSpan() { return lineSpan; }

    public void setLineSpan(int lineSpan) { this.lineSpan = lineSpan; }

    public Color getLineColor() {
      EditorColorsScheme editorScheme =
          EditorColorsManager.getInstance().getGlobalScheme();
      Color color = editorScheme.getColor(
          ImageEditorColorSchemeSettingsKt.getGRID_LINE_COLOR_KEY());
