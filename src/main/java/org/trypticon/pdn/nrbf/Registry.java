...
public class Registry {
    private final Map<Integer, org.trypticon.pdn.nrbf.NrbfReferableRecord> objectsById = Maps.newHashMap();
    ...
    public void registerObject(org.trypticon.pdn.nrbf.NrbfReferableRecord referableType) {
