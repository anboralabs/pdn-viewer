...
public class ClassMetadata {
    ...
    private final ImmutableList<org.trypticon.pdn.nrbf.classes.MemberMetadata> memberMetadata;

    public ClassMetadata(
            @Nullable String libraryName,
            String name,
            ImmutableList<org.trypticon.pdn.nrbf.classes.MemberMetadata> memberMetadata) {
    ...
    public ImmutableList<org.trypticon.pdn.nrbf.classes.MemberMetadata> getMemberMetadata() {
    ...
    public static ClassMetadata composeFrom(
        ...
        ImmutableList.Builder<org.trypticon.pdn.nrbf.classes.MemberMetadata> builder = ImmutableList.builder();
