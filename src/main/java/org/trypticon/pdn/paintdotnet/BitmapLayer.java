...
public class BitmapLayer extends Layer {
    ...
    private final org.trypticon.pdn.paintdotnet.Surface surface;

    public BitmapLayer(NrbfClassRecord record) {
        super(record);
        Map<String, Object> map = record.asMap();
        properties = new BitmapLayerProperties((NrbfClassRecord) map.get("properties"));
        surface = new org.trypticon.pdn.paintdotnet.Surface((NrbfClassRecord) map.get("surface"));
    }
    ...
    public static class BitmapLayerProperties {
        private final org.trypticon.pdn.paintdotnet.UserBlendOps.BlendOp blendOp;
        ...
        public BitmapLayerProperties(NrbfClassRecord record) {
            ...
            switch (blendOpRecord.getMetadata().getName()) {
                case "PaintDotNet.UserBlendOps+NormalBlendOp":
                    blendOp = new org.trypticon.pdn.paintdotnet.UserBlendOps.NormalBlendOp(blendOpRecord);
                    break;
                case "PaintDotNet.UserBlendOps+XorBlendOp":
                    blendOp = new org.trypticon.pdn.paintdotnet.UserBlendOps.XorBlendOp(blendOpRecord);
                    break;
                default:
                    blendOp = new org.trypticon.pdn.paintdotnet.UserBlendOps.NormalBlendOp(blendOpRecord);
                    break;
